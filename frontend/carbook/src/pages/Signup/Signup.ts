...
export default class SignupPage extends Component {
  ...
  <div class='signup-contents'>
    <form class ='input-form'>
      ...
      <input type = 'password' class ='input-box' name = 'signup-password' placeholder='비밀번호를 입력해주세요'/>
      <div class ='signup-nickname'> Nickname</div>
      <input type = 'nickname' class ='input-box' name = 'signup-nickname' placeholder='닉네임을 입력해주세요'/>
